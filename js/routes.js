...
var routes = [
  ...
  {
    path: '/settingsJB/',
    componentUrl: './pages/settings-after-jb.html',
  },

  {
    path: '/wallpaper/',
    componentUrl: './pages/wallpaper.html',
  },
  
  {
    path: '/wallpaperjb/',
    componentUrl: './pages/wallpaperjb.html',
  },


  {
    path: '/choosewallpaper/',
    componentUrl: './pages/choosewallpaper.html',
  },

  {
    path: '/chooseTheme/',
    componentUrl: './pages/choosetheme-before-jb.html',
  },
  {
    path: '/chooseThemeJB-kishuhome/',
    componentUrl: './pages/choosetheme-after-jbhome.html',
  },

  {
    path: '/chooseThemeJB-kishu/',
    componentUrl: './pages/choosetheme-after-jb.html',
  },

  {
    path: '/jailbreak/',
    componentUrl:'./pages/processjb.html',
  },

  {
    path: '/jailbroken/',
    componentUrl:'./pages/jailbrokenprocess.html',
  },

  {
    path: '/jailbreak-chekra1n/',
    componentUrl:'./pages/chekra1n-processjb.html',
  },

  {
    path: '/jailbreak-uncover/',
    componentUrl:'./pages/uncover-processjb.html',
  },


  {
    path: '/cydia/',
    componentUrl:'./pages/cydia.html',
  },

  {
    path: '/wifi/',
    componentUrl: './pages/wifi.html',
  },
  {
    path: '/blutooth/',
    componentUrl: './pages/blutooth.html',
  },

  {
    path: '/sounds/',
    componentUrl: './pages/sounds.html',
  },
  {
    path: '/disturb/',
    componentUrl: './pages/disturb.html',
  },
  {
    path: '/general/',
    componentUrl: './pages/general.html',
  },

  {
    path: '/contacts/',
    componentUrl: './pages/contacts-list.html',
  },
...
/*
     FILE ARCHIVED ON 02:23:21 May 16, 2022 AND RETRIEVED FROM THE
     INTERNET ARCHIVE ON 08:35:51 May 07, 2025.
...
playback timings (ms):
  ...
  esindex: 0.015
  cdx.remote: 75.957
  LoadShardBlock: 194.349 (3)
  PetaboxLoader3.datanode: 181.429 (4)
  PetaboxLoader3.resolve: 198.382 (2)
  load_resource: 215.487
*/